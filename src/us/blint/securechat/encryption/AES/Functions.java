...
public abstract class Functions {
	...
	/**
	 *  Takes a 4-byte input word and applies the inverse S-box
	 *  
	 *  @param in  4 byte word
	 *  @return    input passed through inverse S-box
	 */
	protected byte[] invSubWord(byte[] in) {
		for (int i = 0; i < 4; i++) {
			in[i] = (byte) (invS_box[in[i] & 0xff]);
		}
		return in;
	}
